...
namespace ConsoleApplication1
{
    public class Sample07
    {
        public static void Demo()
        {
            ...
            Console.WriteLine("TaskA result: {0}", taskA.Result); // Blocks for about 5 seconds
            Console.WriteLine("Measured time: " + (DateTime.UtcNow - begin).TotalMilliseconds + " ms.");
            Console.WriteLine("TaskB result: {0}", taskB.Result); // Blocks, but the task is probably already done.
            Console.WriteLine("Measured time: " + (DateTime.UtcNow - begin).TotalMilliseconds + " ms.");
        }
